    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content">
                <form action="{{ route('admin.courses.contents.update',$CourseContent->id) }}" method="POST"
                    ...
                    {{-- <div class="mb-4">
                        ...
                        <input type="number" class="form-control" id="number_of_lecture" name="number_of_lecture" placeholder="Number of Lecture" value="{{ old("number_of_lecture", $CourseContent->number_of_lecture) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" rows="8" name="description"
                                  placeholder="Description">{{ old("description", $CourseContent->description) }}</textarea>
