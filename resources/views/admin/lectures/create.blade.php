            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ route('admin.courses.contents.lectures.index',$courseContent->id) }}">Course Content</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a class="link-fx"
                               href="{{ url('admin/course_content/'. request()->get("course_content_id")) }}">Lecture</a>
                        </li>
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title">
                    Create Lecture for ({{ $courseContent->title }})
                </h3>
            </div>
            <div class="block-content">
                <form action="{{ route('admin.courses.contents.lectures.store',$courseContent->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <input type="hidden" name="course_content_id" value="{{ $courseContent->id }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" class="form-control" id="video" name="video" placeholder="Video URL">
                        @if ($errors->has('video'))
