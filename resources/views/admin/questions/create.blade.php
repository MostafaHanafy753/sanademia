            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
                ...
                <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item">
                            <a class="link-fx" href="{{ url('admin/exam/' . Request::segment(3)) }}">Question</a>
                        </li>
                ...
                <form action="{{ route('admin.question.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-control" id="type" name="type">
                            <option {{ old('type') == 'Option' ? "selected" : "" }}>Option</option>
                            <option {{ old('type') == 'Audio' ? "selected" : "" }}>Audio</option>
                        </select>
                        @if ($errors->has('type'))
