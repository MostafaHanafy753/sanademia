...
<head>
    ...
    <!-- Icons --><meta name="csrf-token" content="{{ csrf_token() }}">
            ...
            <div class="js-sidebar-scroll">
                ...
                <div class="content-side">
                    <ul class="nav-main">
                        ...
                        <li
                            class="nav-main-item{{ Route::currentRouteName() == 'admin.courses.index' || request()->is('course/statistics') || request()->is('course/create') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                ...
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('admin/course/create') ? ' active' : '' }}" --}}
                        ...
                        <li
                            class="nav-main-item{{ Route::currentRouteName() == 'admin.accounting.index' ? ' open' : '' }}">
                            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                                aria-expanded="true" href="#">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        // Select all <a> tags with href="/pages/blank"
        document.querySelectorAll('a[href="/pages/blank"]').forEach(function(link) {
